...
- [OhMyPackageException.cs](file://Assets/TEngine/Runtime/Core/Utility/OhMyPackageException.cs)
</cite>
...
L3["OhMyPackageException<br/>异常封装"]
end
P1 --> R1
E1 --> P1
E2 --> E1
...
- [OhMyPackageException.cs:10-49](file://Assets/TEngine/Runtime/Core/Utility/OhMyPackageException.cs#L10-L49)
...
- 日志与异常（Log/DefaultLogHelper/OhMyPackageException）
...
- 错误处理
  - 类型解析失败或创建失败时抛出OhMyPackageException，便于上层捕获。
...
#### 1. 模块注册失败
- 现象
  - 模块类型解析失败，抛出OhMyPackageException。
- 根因
