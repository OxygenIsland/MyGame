...
DS["数据结构<br/>OhMyPackageLinkedList"]
end
subgraph "资源模块"
...
- [OhMyPackageLinkedList.cs:12-393](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs#L12-L393)
...
### 数据结构：链表节点缓存复用
- OhMyPackageLinkedList对LinkedListNode进行缓存复用，减少频繁分配
