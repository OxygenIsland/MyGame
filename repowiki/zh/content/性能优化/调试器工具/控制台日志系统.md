...
<cite>
**本文档引用的文件**
- [OhMyPackageLog.cs](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLog.cs)
- [OhMyPackageLogLevel.cs](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLogLevel.cs)
...
graph TB
subgraph "日志核心层"
A[OhMyPackageLog.cs<br/>主日志入口]
B[OhMyPackageLogLevel.cs<br/>日志级别定义]
C[Log.cs<br/>便捷日志接口]
end
subgraph "默认实现层"
...
**图表来源**
- [OhMyPackageLog.cs:1-50](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLog.cs#L1-L50)
...
**章节来源**
- [OhMyPackageLog.cs:1-100](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLog.cs#L1-L100)
...
OhMyPackageLog --> ILogHelper : "依赖"
DefaultLogHelper ..|> ILogHelper : "实现"
OhMyPackageLog --> DefaultLogHelper : "默认实现"
```

**图表来源**
- [OhMyPackageLog.cs:6-17](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLog.cs#L6-L17)
- [OhMyPackageLog.ILogHelper.cs:8-16](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLog.ILogHelper.cs#L8-L16)
...
**章节来源**
- [OhMyPackageLogLevel.cs:1-34](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLogLevel.cs#L1-L34)
- [OhMyPackageLog.cs:1-200](file://Assets/TEngine/Runtime/Core/Lib/TEngine/Runtime/Core/Log/OhMyPackageLog.cs#L1-L200)
...
```csharp
public class CustomLogHelper : OhMyPackageLog.ILogHelper
{
    public void Log(OhMyPackageLogLevel level, object message)
    {
        // 实现自定义格式化逻辑
    ...
    private string FormatMessage(OhMyPackageLogLevel level, object message)
    {
        // 自定义格式化实现
