...
subgraph "日志系统"
OhMyPackageLog[OhMyPackageLog.cs<br/>日志框架]
OhMyPackageLogLevel[OhMyPackageLogLevel.cs<br/>日志级别]
Log[Log.cs<br/>日志接口]
end
subgraph "内存管理"
...
subgraph "应用层"
GameApp[游戏应用程序]
OhMyPackage[OhMyPackage]
end
subgraph "日志接口层"
LogInterface[Log.cs<br/>统一日志接口]
LogLevelEnum[OhMyPackageLogLevel.cs<br/>日志级别枚举]
end
subgraph "日志实现层"
OhMyPackageLog[OhMyPackageLog.cs<br/>日志框架实现]
...
OhMyPackage --> LogInterface
LogInterface --> OhMyPackageLog
OhMyPackageLog --> LogHelper
