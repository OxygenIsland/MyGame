...
- [OhMyPackageLinkedList.cs](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs)
- [OhMyPackageLinkedListRange.cs](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs)
...
GLL["OhMyPackageLinkedList<br/>链表"]
GLLR["OhMyPackageLinkedListRange<br/>链表范围"]
end
subgraph "模块层"
...
- [OhMyPackageLinkedList.cs:1-393](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs#L1-L393)
- [OhMyPackageLinkedListRange.cs:1-181](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L1-L181)
- [IObjectPool.cs](file://Assets/TEngine/Runtime/Module/ObjectPoolModule/IObjectPool.cs)
...
- 链表与范围迭代器（OhMyPackageLinkedList、OhMyPackageLinkedListRange）：提供节点缓存与范围遍历，降低GC与提升遍历效率
...
- [OhMyPackageLinkedList.cs:289-309](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs#L289-L309)
- [OhMyPackageLinkedListRange.cs:118-178](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L118-L178)
- [IObjectPool.cs](file://Assets/TEngine/Runtime/Module/ObjectPoolModule/IObjectPool.cs)
...
- 使用建议
  ...
  - 使用范围迭代器替代临时列表拷贝
- 关键路径参考
  - 节点获取：[AcquireNode:289-303](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs#L289-L303)
  - 节点回收：[ReleaseNode:305-309](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs#L305-L309)
  - 范围计数：[Count:51-68](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L51-L68)
  - 范围遍历：[Enumerator.MoveNext:158-168](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L158-L168)
...
章节来源
- [OhMyPackageLinkedList.cs:289-309](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedList.cs#L289-L309)
- [OhMyPackageLinkedListRange.cs:51-68](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L51-L68)
- [OhMyPackageLinkedListRange.cs:158-168](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L158-L168)
...
- 链表与范围迭代器
  - OhMyPackageLinkedListRange依赖OhMyPackageLinkedList的节点结构
- 模块层
...
GLL["OhMyPackageLinkedList"] --> GLR["OhMyPackageLinkedListRange"]
...
- 链表遍历异常
  - 症状：范围遍历抛出异常或死循环
  - 排查：确认范围构造参数与终止标记一致性
  - 参考：[OhMyPackageLinkedListRange构造:22-31](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L22-L31)
...
- [OhMyPackageLinkedListRange.cs:22-31](file://Assets/TEngine/Runtime/Core/DataStruct/OhMyPackageLinkedListRange.cs#L22-L31)
